...
(function () {
  ...
  var ASTSwift_prototype = function ASTSwift_prototype() {
  ...
  var ASTSwift = function ASTSwift(a, b, c, d, e, f, g, h) {
    var m = this,
        res;
    if (m instanceof ASTSwift) {
      ...
      if (m.__factoryClass) {
        ...
        if (typeof res == "function") {
          if (res._classInfo.name != ASTSwift._classInfo.name) return new res(a, b, c, d, e, f, g, h);
        } else {
          if (res) return res;
        }
      }
    ...
    } else return new ASTSwift(a, b, c, d, e, f, g, h);
  };
  // inheritance is here
  ...
  ASTSwift.prototype = new ASTSwift_prototype();

  (function () {
    if (typeof define !== "undefined" && define !== null && define.amd != null) {
      __amdDefs__["ASTSwift"] = ASTSwift;
      this.ASTSwift = ASTSwift;
    } else if (typeof module !== "undefined" && module !== null && module.exports != null) {
      module.exports["ASTSwift"] = ASTSwift;
    } else {
      this.ASTSwift = ASTSwift;
    }
